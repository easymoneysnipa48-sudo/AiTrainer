...
SECTIONS = {
    "intro": {
        ...
        "energy": 0.3,
        "phrasing": "sparse piano, atmospheric pads",
        "tail": "low energy",
    },
    "verse": {
        "instruments": ["piano", "808 bass", "drums"],
        "mood": ["dark", "emotional"],
        "energy": 0.55,
        "phrasing": "restrained drums, deep 808 bass",
        "tail": "narrative mood, medium energy",
    },
    "pre-chorus": {
        "instruments": ["strings", "riser", "drums"],
    ...
    "chorus": {
        ...
        "energy": 0.9,
        "phrasing": "wide strings, heavy drums",
    ...
    "outro": {
        ...
        "energy": 0.25,
        "phrasing": "reduced drums, fading piano",
        "tail": "fading piano, reflective mood",
    },
}
